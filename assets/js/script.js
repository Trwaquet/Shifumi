...
/* ----- Ce Bouton représente la Pierre ----- */
    ...
    {
        computerChoice = 'rock';
        document.getElementById('ordisChoiceImg').innerHTML="<img src='./assets/img/Rock 250px.png'  id=imgChoice width=100% />";
    }
    else if(computerChoice <= 0.40)
    {
        computerChoice = 'paper';
        document.getElementById('ordisChoiceImg').innerHTML="<img src='./assets/img/Paper 250px.png'  id=imgChoice width=100% />";
    }
    else if(computerChoice <= 0.60)
    {
        computerChoice = 'scissors';
        document.getElementById('ordisChoiceImg').innerHTML="<img src='./assets/img/Scissors 250px.png'  id=imgChoice width=100% />";
    }
    else if (computerChoice <= 0.80)
    {
        computerChoice = 'lezard';
        document.getElementById('ordisChoiceImg').innerHTML="<img src='./assets/img/Lezard 250px.png'  id=imgChoice width=100% />";
    }
    else {
        computerChoice = 'spock';
        document.getElementById('ordisChoiceImg').innerHTML="<img src='./assets/img/Spock 250px.png'  id=imgChoice width=100% />";
    }
...
Et entre pierre, papier, ciseaux, lezard, spock */
    ...
    document.getElementById('userChoiceImg').innerHTML="<img src='./assets/img/Rock 250px.png'  id=imgChoice width=100% />";
...
Et entre pierre, papier, ciseaux, lezard, spock */
    ...
    let result = document.getElementById('resultShifumi');
    document.getElementById('userChoiceImg').innerHTML="<img src='./assets/img/Paper 250px.png'  id=imgChoice width=100% />";
...
Et entre pierre, papier, ciseaux, lezard, spock */
    ...
    let result = document.getElementById('resultShifumi');
    document.getElementById('userChoiceImg').innerHTML="<img src='./assets/img/Scissors 250px.png'  id=imgChoice width=100% />";
...
Et entre pierre, papier, ciseaux, lezard, spock */
    ...
    let result = document.getElementById('resultShifumi');
    document.getElementById('userChoiceImg').innerHTML="<img src='./assets/img/Lezard 250px.png'  id=imgChoice width=100% />";
...
Et entre pierre, papier, ciseaux, lezard, spock */
    ...
    let result = document.getElementById('resultShifumi');
    document.getElementById('userChoiceImg').innerHTML="<img src='./assets/img/Spock 250px.png'  id=imgChoice width=100% />";
